// Origin-Core — order code generator + small UI behaviors
...
function buildPanel(container, code, planName) {
  container.innerHTML = `
    <div class="label">کد سفارش شما برای «${planName}»</div>
    <div class="code-row">
    ...
    <div class="hint">این کد را کپی کنید و برای خرید و تحویل، به آیدی تلگرام <b>${TELEGRAM_ID}</b> ارسال نمایید.</div>
  `;
